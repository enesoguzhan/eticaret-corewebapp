namespace DataAccessLayer.Mappings
{
    public class ProductsMap : IEntityTypeConfiguration<Products>
    {
        public void Configure(EntityTypeBuilder<Products> builder)
        {
            ...
            builder.Property(x => x.Images1).HasMaxLength(50);
            builder.Property(x => x.Images2).HasMaxLength(50);
            builder.Property(x => x.Images3).HasMaxLength(50);
            builder.Property(x => x.Images4).HasMaxLength(50);
